...
AuthGGName = "Auth.GG"
AuthGGIcon = "https://i.imgur.com/6xMaB6h.png"
AuthGGUrl = "https://auth.gg/"
...
async def Help(ctx, Category="None"):
    ...
    HelpEmbed.set_author(name=AuthGGName, icon_url=AuthGGIcon, url=AuthGGUrl)
...
async def Info(ctx):
    ...
    CreditsEmbed.set_author(name=AuthGGName, icon_url=AuthGGIcon, url=AuthGGUrl)
...
async def AppInfo(ctx):
    ...
    AppStatsEmbed.set_author(name=AuthGGName, icon_url=AuthGGIcon, url=AuthGGUrl)
...
async def AuthStatus(ctx):
    ...
    AuthStatusEmbed.set_author(name=AuthGGName, icon_url=AuthGGIcon, url=AuthGGUrl)
    AuthStatusEmbed.set_thumbnail(url=AuthGGIcon)
...
async def FetchUser(ctx, Username):
    ...
    if FetchedUser['status'] == "success":
        ...
        FetchUserEmbed.set_author(name=AuthGGName, icon_url=AuthGGIcon, url=AuthGGUrl)
        FetchUserEmbed.set_footer(text=ctx.guild.name, icon_url=ctx.guild.icon_url_as(format=None, static_format='png', size=1024))
        await ctx.send(embed=FetchUserEmbed)
...
async def FetchUsers(ctx):
    ...
    FetchedUsersEmbed.set_author(name=AuthGGName, icon_url=AuthGGIcon, url=AuthGGUrl)
    ...
    while True:
        try:
            ...
            NewFetchedUsersEmbed.set_author(name=AuthGGName, icon_url=AuthGGIcon, url=AuthGGUrl)
...
async def DeleteUser(ctx, Username):
    ...
    DeleteUserEmbed=discord.Embed(title="Delete User", description=f"**Status:** {DeletedUser['value']}\n**Info:** {DeletedUser['info']}", color=AuthGGColor, timestamp=datetime.datetime.utcnow())
    DeleteUserEmbed.set_author(name=AuthGGName, icon_url=AuthGGIcon, url=AuthGGUrl)
...
async def ChangeVariable(ctx, Username, *, Variable):
    ...
    ChangeVariableEmbed.set_author(name=AuthGGName, icon_url=AuthGGIcon, url=AuthGGUrl)
...
async def ChangePassword(ctx, Username, Password):
    ...
    ChangePasswordEmbed.set_author(name=AuthGGName, icon_url=AuthGGIcon, url=AuthGGUrl)
...
async def FetchLicense(ctx, License):
    ...
    if FetchedLicense['status'] == "success":
        ...
        FetchLicenseEmbed.set_author(name=AuthGGName, icon_url=AuthGGIcon, url=AuthGGUrl)
...
async def FetchLicenses(ctx):
    ...
    FetchLicensesEmbed.set_author(name=AuthGGName, icon_url=AuthGGIcon, url=AuthGGUrl)
    ...
    while True:
        try:
            ...
            NewFetchLicensesEmbed.set_author(name=AuthGGName, icon_url=AuthGGIcon, url=AuthGGUrl)
...
async def DeleteLicense(ctx, License):
    ...
    DeleteLicenseEmbed.set_author(name=AuthGGName, icon_url=AuthGGIcon, url=AuthGGUrl)
...
async def UseLicense(ctx, License):
    ...
    UseLicenseEmbed.set_author(name=AuthGGName, icon_url=AuthGGIcon, url=AuthGGUrl)
...
async def UnuseLicense(ctx, License):
    ...
    UnuseLicenseEmbed.set_author(name=AuthGGName, icon_url=AuthGGIcon, url=AuthGGUrl)
...
async def GenerateLicense(ctx, Amount : int = 1, Days : int = 1, Level : int = 1, Format : int = 2, Prefix : str = " ", Length : int = 0):
    ...
    if Amount < 50:
        ...
        GenerateLicenseEmbed.set_author(name=AuthGGName, icon_url=AuthGGIcon, url=AuthGGUrl)
...
async def FetchHWID(ctx, Username):
    ...
    if FetchedHWID['status'] == "success":
        ...
        FetchHWIDEmbed.set_author(name=AuthGGName, icon_url=AuthGGIcon, url=AuthGGUrl)
